...
const specialOffers = [
  {
    ...
    description: 'Book 3 months in advance and save big on this Greek island paradise.',
    tag: 'Early Bird',
    duration: '6 Days',
  },
  {
    ...
    description: 'Grab this incredible last-minute offer for luxury Dubai experience.',
    tag: 'Last Minute',
    duration: '5 Days',
  },
  {
    ...
    description: 'Book for 4+ people and enjoy exclusive group rates on this epic adventure.',
    tag: 'Group Deal',
    duration: '7 Days',
  },
  {
    ...
    description: 'Perfect weekend getaway with amazing savings on flights and hotel.',
    tag: 'Weekend',
    duration: '3 Days',
  },
];
