...
const WhyChooseUs = () => {
  const features = [
    ...
    },
    {
      icon: FaAward,
      title: 'Award Winning',
      description: 'Recognized globally for excellence in travel and customer service.',
      color: 'text-red-500',
      bg: 'bg-red-50',
    },
    {
      ...
      description: 'Access to over 150 destinations worldwide with local expert guides.',
